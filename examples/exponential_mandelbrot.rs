...
const FILENAME: &str = "exponential_mandelbrot.png";

const FRACTAL: Fractal<f64> = Fractal::ExponentialMandelbrot;

const CENTRE: Complex<f64> = Complex::new(-1.0, 0.0);
const MAX_ITER: u32 = 100;
const SCALE: f64 = 4.0e-2;
