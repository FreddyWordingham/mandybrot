...
const FILENAME: &str = "lorenz.png";

const ATTRACTOR: Attractor<f64> = Attractor::Lorenz {
    sigma: 10.0,
    rho: 28.0,
    beta: 8.0 / 3.0,
    dt: 1.0e-6,
...
fn main() {
    ...
    let data = render_attractor(CENTRE, CENTRE, MAX_ITER, SCALE, RESOLUTION, ATTRACTOR);
